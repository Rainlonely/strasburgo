<?php
global $pmc_data; 
$use_bg = ''; $background = ''; $custom_bg = ''; $body_face = ''; $use_bg_header =''; $background_header = ''; $custom_bg_header = ''; $background_h_f ='';
...
if(isset($pmc_data['background_patterm_footer_header'])) {
	$use_bg_h_f = $pmc_data['background_patterm_footer_header'];
	
}


if($use_bg || $use_bg_full) {
...
if($use_bg_h_f ) {
	...
	$bg_img = $pmc_data['h_f_bg'];

	
	$background_h_f = 'url('. $bg_img .') repeat' ;
...
#headerwrap, #footer{background:<?php echo $pmc_data['header_background_color'].' '.$background_h_f ?>  !important;}
...
body {	 
	...
	font-size: <?php echo $pmc_data['body_font']['size']; ?> !important;
	font-weight: normal;
...
a:hover, h2.title a:hover, .item3 h3:hover, .item4 h3:hover, .item3 h3 a:hover{color: <?php echo $pmc_data['mainColor']; ?>;}
.product-remove a:hover {color: <?php echo $pmc_data['mainColor']; ?> !important;}
.item3 h3, .item4 h3, .item3 h3 a, .item4 h3 a, .item3 h4, .item4 h4 {color:<?php echo $pmc_data['heading_font_h3']['color']; ?>;}
...
.blogpostcategory .overdefultlink{background: <?php echo HexToRGB($pmc_data['mainColor'], 0.8); ?> url(images/plusIcon.png) no-repeat 370px 165px;}
 .item4 .overdefult {background: <?php echo HexToRGB($pmc_data['mainColor'], 0.8); ?> url(images/plusIcon.png) no-repeat 105px 85px;}
.rightContentSP .single_add_to_cart_button:hover {background:none !important;border:2px solid <?php echo $pmc_data['mainColor']; ?> }
/* ***********************
--------------------------------------
------------BOX FONT COLOR----------
--------------------------------------
...
--------------------------------------
*********************** */
#logo a, .recentborder,.item4 .recentborder, .item3 .recentborder,.afterlinehome,.borderLineLeft, .borderLineLeftSlideshow  {border-color:<?php echo $pmc_data['mainColor']; ?> ;}
...
.products-both .tabsshort .ui-tabs-active, .homerecent.SP h3.h3border, .portsingle h3.h3border{border-top:6px solid <?php echo $pmc_data['mainColor']; ?>;}
.homerecent .productR .recentCart a:hover {border:2px solid <?php echo $pmc_data['mainColor']; ?>;}
...
{	font-family: <?php echo str_replace("%20"," ",str_replace(":300"," ",str_replace(":200"," ",str_replace(":400"," ",$pmc_data['body_font']['face'])))); ?>, "Helvetica Neue", Arial, Helvetica, Verdana, sans-serif !important; }
.menu > li a {	font-family: <?php echo str_replace("%20"," ",str_replace(":300"," ",str_replace(":200"," ",str_replace(":400"," ",$pmc_data['menu_font'])))); ?>, "Helvetica Neue", Arial, Helvetica, Verdana, sans-serif !important; color:<?php echo $pmc_data['menu_color']; ?>;letter-spacing: normal;}
...
.blogpost .datecomment a, .content ol.commentlist li .comment-author .fn a{color:<?php echo $pmc_data['body_font']['color']; ?>;}
.blogpost .datecomment a:hover, .tags a:hover, .content ol.commentlist li .comment-author .fn a:hover{ color:<?php echo $pmc_data['mainColor']; ?>; }
...
.pagecontent h1, .pagecontent p, .pagecontentContent #breadcrumb {text-shadow:0 1px 0 <?php echo HexToRGB($pmc_data['ShadowColorFont'],$pmc_data['ShadowOpacittyColorFont'])?>;}
...
------------BOXED---------------------
-----------------------------------*/
<?php if($pmc_data['use_boxed'] == 0 &&  $pmc_data['use_background'] == 1){ ?>
...
<?php	} ?>
 ...
 <?php if(isset($pmc_data['use_boxed'])){ ?>
header,.aq-block,.outerpagewrap,.mainwrap,.pagewrap{background:none !important;}
header,.aq-block,.outerpagewrap,.mainwrap,.pagewrap{background-color:#fff !important;}
@media screen and (min-width:1220px){
body {width:1220px !important;margin:0 auto !important;border:1px solid #eee !important;}
...
@media screen and (min-width:0px) and (max-width:1180px){
	...
	/*RESPONSIVE MENU */
	.respMenu {text-transform:uppercase;font-size:18px;text-align: center; color:#121212;font-weight:bold;margin:30px 0 20px -18px; padding:20px 32px 20px 32px;cursor:pointer; background:#fdfdfd;border:1px solid #eee; width:auto; display:inline-block;}
	...
	.cartWrapper {background:#fdfdfd;border:1px solid #eee; padding:15px 15px 15px 0 !important; margin:20px 0 0 10px !important;}	
...
@media screen and (min-width:460px) and (max-width:1180px){
	...
	.homerecent .one_fourth {width: 48.5% !important;text-align: center;margin: 2% auto; margin-left: 0.6%;}
